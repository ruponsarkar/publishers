...
<h2>Apply For Editorial Board Member</h2>
  <form method="POST" action="database/editor-join.php" enctype="multipart/form-data">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="number" id="mobile" name="mobile" placeholder="Enter Your Mobile Number (Country code mandatory)">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    <div class="row">
      <div class="col-25">
        <label for="name">Select Area or Department</label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
      <div class="col-25">
        <label for="subject">List Of Publication</label>
      </div>
      <div class="col-75">
        <textarea id="publication" name="publication" placeholder="List of publication.." style="height:100px"></textarea>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-25">
        <label for="name">Upload passport size Photo</label>
      </div>
      <div class="col-75">
        <input type="file" accept=".jpg, .jpeg, .png" id="photo" name="photo">
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-25">
        <label for="name">Upload CV/Resume</label>
      </div>
      <div class="col-75">
        <input type="file" accept=".pdf, .docx, .doc" id="cv" name="cv">
      </div>
    </div>
    ...
    <div class="row">
      <input type="submit" name="editor-submit" value="Submit">
    </div>
  </form>
</div>
