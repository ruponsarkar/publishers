  ...
  <div class="card">
    ...
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        ...
        <button onclick="window.location.href='journal-details/journal-details.php?id=<?php echo $id; ?>';" onclick="window.location.href='../archive.php?j_id=<?php  echo $result['j_id'];  ?>';" class="btn btn-danger collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
          Archives |
        </button>
...
$sql = "SELECT * FROM volume WHERE j_id = $id";
$qry = mysqli_query($con,$sql);
...
<a href="issues.php?id=<?php echo $row['id'];  ?>&j_id=<?php echo $id ?>&volume=<?php echo $row['name'];  ?>">
